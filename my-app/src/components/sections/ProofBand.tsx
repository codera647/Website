                    ...
                    {stat.layout === "list" ? (
                        <ul className="mx-auto mt-5 flex w-full max-w-[280px] flex-col gap-2">
                            {stat.proof.map((item) => (
                                <li key={item.text}>
                                    <Link
                                        href={item.href ?? "#"}
                                        className="flex h-12 items-center justify-between gap-3 rounded-none border border-line bg-[#F5F3E4] px-4 text-left transition-colors hover:border-ink hover:shadow-[0_8px_20px_-12px_rgba(17,17,19,0.25)]"
                                    >
                        ...
                        <ul className="mx-auto mt-5 flex max-w-xs flex-wrap justify-center gap-2">
                            {stat.proof.map((item) => (
                                <li
                                    key={item.text}
                                    className="rounded-none border border-line bg-[#F5F3E4] px-3.5 py-1.5 text-xs font-medium text-ink-soft"
                                >
                                    {item.text}
                                </li>
                            ))}
