...
export default function MomentumSystemsPage() {
    ...
    return (
        <main>
                    ...
                    <div className="mt-16 space-y-8">
                        {PILLARS.map((p, i) => (
                            <FadeInWhenVisible key={p.number} delay={i * 0.1}>
                                <div className="card-hover group grid gap-8 rounded-2xl border border-line bg-[#7a7a7c] p-8 transition-all hover:border-ink md:p-12 lg:grid-cols-12 lg:gap-12">
                                    <div className="lg:col-span-5 flex flex-col justify-between">
                                        ...
                                        <div className="mt-6 rounded-xl border border-line bg-surface p-4 text-xs leading-relaxed text-muted transition-colors group-hover:bg-[#7a7a7c] group-hover:border-ink/20">
            ...
            <section className="border-t border-line bg-[#7a7a7c] py-24 md:py-32">
                <div className="container-wide">
                    <FadeInWhenVisible>
                        <p className="font-heading text-xs font-medium uppercase tracking-[0.28em] text-muted">
            ...
            <section className="border-t border-line bg-surface/50 py-24 md:py-32">
                <div className="container-wide">
                    ...
                    <div className="card-hover mt-14 overflow-x-auto rounded-2xl border border-line bg-[#7a7a7c] shadow-sm transition-all hover:border-ink">
                    ...
                    <FadeInWhenVisible delay={0.2} className="mt-8">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 rounded-2xl border border-line bg-[#7a7a7c] p-6 sm:p-8">
                            <div>
                            ...
                            <div className="flex flex-wrap items-center gap-3 shrink-0">
                                <SurveyTriggerButton
                                    className="rounded-none border border-ink bg-[#7a7a7c] px-5 py-3 font-heading text-xs font-bold uppercase tracking-wider text-ink hover:bg-ink hover:text-white transition-all cursor-pointer shadow-sm"
                                >
                                    Take 1-Min Survey 🎯
                                </SurveyTriggerButton>
                                <Link
