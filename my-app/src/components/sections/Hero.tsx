                ...
                <div className="mt-8 max-w-xl">
                    ...
                    >
                        ...
                        <BookCallButton
                            ...
                            className="cursor-pointer rounded-none border border-line bg-[#7a7a7c] px-7 py-3.5 font-heading text-sm font-semibold text-ink transition-all duration-300 hover:-translate-y-0.5 hover:border-ink"
                        >
                            Let&apos;s talk
                        </BookCallButton>
                    </motion.div>
                    ...
                    {services.map((service, i) => (
                        ...
                        >
                            <Link
                                ...
                                className="card-hover group flex h-full flex-col rounded-2xl border border-line bg-[#7a7a7c] p-6"
                            >
