                ...
                <section className="border-t border-line bg-surface">
                    <div className="mx-auto max-w-5xl px-6 py-14 md:py-16">
                        <FadeInWhenVisible>
                            ...
                            <Link
                                href="/ai-engagements"
                                className="mt-5 inline-block rounded-none border border-line bg-[#7a7a7c] px-6 py-3 font-heading text-sm font-semibold text-ink transition-all duration-300 hover:-translate-y-0.5 hover:border-ink"
                            >
