        ...
        >
            {labels.slice(0, SLOTS.length).map((label, i) => (
                <motion.span
                    key={label}
                    style={SLOTS[i]}
                    className="absolute rounded-none border border-line bg-background/85 px-3.5 py-1.5 font-heading text-xs font-medium text-ink-soft shadow-sm backdrop-blur"
