 ...
 * the AI chat widget, and Cal.com for call booking (verified against
...
export const termsSections: LegalSection[] = [
    ...
    },
    {
        ...
        blocks: [
            p(
                "The Website relies on a small number of third-party services to function: Cloudflare for hosting, security, and the infrastructure behind the AI chat assistant, Resend for delivering emails from our contact and careers forms, and Cal.com for scheduling calls. Links to LinkedIn, Instagram, and other platforms are provided for convenience."
            ),
            p(
...
export const privacySections: LegalSection[] = [
    ...
    },
    {
        ...
        blocks: [
            ...
            list([
                ...
                "Call booking: when you book a call through our Cal.com scheduler, Cal.com collects your name, email, and the details needed to schedule the meeting, on its own systems and under its own privacy policy.",
    ...
    },
    {
        ...
        blocks: [
            ...
            list([
                ...
                "Cal.com, if you choose to book a call, which then processes your booking details directly under its own privacy policy.",
            ]),
            p(
    ...
    },
    {
        ...
        blocks: [
            p(
                "The Website links to third-party platforms, including LinkedIn, Instagram, and Gmail's compose interface, and embeds a Cal.com scheduling widget for booking calls. Once you leave our Website, or interact with an embedded third-party widget, that platform's own privacy policy applies, and we encourage you to review it."
            ),
        ],
    },
    {
