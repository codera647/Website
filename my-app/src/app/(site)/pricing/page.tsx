...
function TierCard({ tier, index }: { tier: PricingTier; index: number }) {
    return (
        <FadeInWhenVisible delay={index * 0.1} className="flex">
            <div
                className={`card-hover group flex w-full flex-col justify-between rounded-2xl border bg-[#7a7a7c] p-8 transition-all md:p-10 ${
        ...
        <main>
            ...
            <section className="container-wide pb-16 pt-36 md:pb-24 md:pt-44">
                ...
                <FadeInWhenVisible delay={0.1} className="mt-10">
                    ...
                    <div className="mt-4 flex flex-col gap-4 rounded-xl border border-line bg-[#7a7a7c] p-5 sm:flex-row sm:items-center sm:justify-between shadow-sm">
                        <div className="flex items-center gap-3">
            ...
            <section className="border-t border-line bg-surface/40 py-20 md:py-28">
                <div className="container-wide">
                    ...
                    <FadeInWhenVisible delay={0.3} className="mt-12">
                        <div className="rounded-xl border border-line bg-[#7a7a7c] p-6 md:p-8">
            ...
            <section id="ai-add-ons" className="scroll-mt-28 border-t border-line bg-[#7a7a7c] py-20 md:py-28">
                <div className="container-wide">
                    <FadeInWhenVisible>
            ...
            <section className="border-t border-line bg-[#7a7a7c] py-20 md:py-28">
                <div className="container-wide">
                    <FadeInWhenVisible>
                        <p className="font-heading text-xs font-medium uppercase tracking-[0.28em] text-muted">
                            Our Commitments
